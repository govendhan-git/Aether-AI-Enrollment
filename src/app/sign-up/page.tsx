    ...
    <div className="container py-10 text-slate-900 dark:text-slate-100">
      <div className="max-w-xl mx-auto glass glass-card glow-border p-6 space-y-5">
        <div className="space-y-3">
          <div>
            <h1 className="text-2xl font-semibold neon-title">Create your account</h1>
            <p className="text-sm opacity-80">Join your agentic benefits experience.</p>
          </div>
        ...
        <div className="glass rounded-2xl border border-white/20 dark:border-white/10 p-4">
          <SignUp
            routing="hash"
            appearance={{
              elements: {
